...
#define SIZEOFSHMSEG 128000     /* Size of the shared mem segment    */
...
int main(int argc, char *argv[])
{
    ...
    for (i=0; i < NUMMSG; i++)
    {
        ...
        // TODO Application logic read a new package here
        //printf("Received packet %i..\n", i);
        //sleep(1);
        memcpy(buff, shm_address, SIZEOFSHMSEG);
    ...
    double MB = ((double)NUMMSG * (double)SIZEOFSHMSEG) / (double)1000000;
